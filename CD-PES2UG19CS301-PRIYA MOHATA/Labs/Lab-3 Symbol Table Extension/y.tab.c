...
{
       0,    27,    27,    30,    31,    32,    33,    37,    41,    42,
      45,    59,    78,    79,    80,    81,    85,   101,   102,   109,
     122,   134,   138,   150,   162,   165,   166,   189,   200,   211,
     212,   213,   214,   215,   216,   221,   223,   224,   227,   228,
     229,   233,   234,   237
};
#endif
...
#line 59 "parser.y"
				...
				/*
                    		...
                    		*/
							...
							{
								symbol* s = allocate_space_for_table_entry(yyvsp[0], size, type, yylineno, 1);
								insert_into_table(s);
							}
			}
#line 1461 "y.tab.c"
  ...
  case 12:
#line 78 "parser.y"
             {type = 2; size = sizeof(short int);}
#line 1467 "y.tab.c"
    break;

  case 13:
#line 79 "parser.y"
                 {type = 3; size = sizeof(float);}
#line 1473 "y.tab.c"
    break;

  case 14:
#line 80 "parser.y"
                  {type = 4; size = sizeof(double);}
#line 1479 "y.tab.c"
    break;

  case 15:
#line 81 "parser.y"
                {type = 1; size = sizeof(char);}
#line 1485 "y.tab.c"
    break;
